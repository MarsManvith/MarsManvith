...
🛠️ Technical Toolkit
Languages: Java, Python, C++, C, JavaScript/TypeScript, HTML/CSS, SQL (Postgres), SQL++, R, Matlab, Swift, Assembly, Git.
Technologies: AWS (Bedrock, Lambda, DynamoDB, S3, OpenSearch), Pandas, Sklearn, NumPy, OpenCV, FastAPI, PySpark,
Apache Spark, Pytorch, Matplotlib, Seaborn, React, Angular, Next.js, Node.js, Express.js, Docker, Kubernetes, Linux.
...
🏆 Innovator: 2025 MATE ROV Sharkpedo Innovation Award winner and 4th place internationally at DubsTech HealthML Hackathon.
